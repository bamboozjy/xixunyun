<template>
	<div id="equipment">
		<el-row>
		  <el-col :span="24">
		  	<div class="grid-content examine" style="font-size: 16px;color: #2b7dbc;padding-left:10px;text-align: left;border-bottom: 1px dashed #ccc;padding-bottom: 15px;">设备查询</div>
		  </el-col>
		</el-row>
		<el-row>
		  <el-col :span="24">
