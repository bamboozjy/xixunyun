<template>
	<div id="baofei">
		<el-row>
		  <el-col :span="24">
		  	<div class="grid-content examine" style="font-size: 16px;color: #2b7dbc;padding-left:10px;text-align: left;border-bottom: 1px dashed #ccc;padding-bottom: 15px;">设备报废</div>
		  </el-col>
		</el-row>
		<el-row>
		  <el-col :span="24">
				...
				<el-table
				    ...
				    <el-table-column
				      ...
				      <template slot-scope="scope">
				        <button @click="handleClick(scope.row,$event)" type="text" size="small" >报废</button>
